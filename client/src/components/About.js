                ...
                <Row className="about-content">
                    <Col lg={8} className="left-div">
                        ...
                        <p>In 2014, two high school students embarked on a journey that would change their lives and the lives of many others.
                            ...
                            Thus, the concept of ServiceSquad was born.</p>
                        <h2>The Growth </h2>
                        <p>Fast forward to today, ServiceSquad has grown exponentially.
                            ...
                            It’s about the impact each volunteer makes in their community, the difference each organization can make with the right resources, and the collective change we can bring about when we work together.</p>
                        <h2>What They Do </h2>
                        <p>ServiceSquad serves as a bridge between volunteers and organizations.
                            ...
                            It simplifies the process of finding and signing up for volunteer opportunities, making community service more accessible and efficient.</p>
                        <h2>The Impact </h2>
                        <p>The impact of ServiceSquad extends beyond just connecting volunteers with organizations.
                            ...
                            Every volunteer opportunity filled through ServiceSquad is a step towards a better world.</p>
                        <h2>The Future </h2>
                        <p>ServiceSquad is growing, and its potential is limitless.
                            ...
                            The future of ServiceSquad is bright, filled with countless more connections, opportunities, and impacts.</p>
                        <h2>In Conclusion </h2>
                        <p>ServiceSquad started as a simple idea in the minds of two high school students.
                            ...
                            As ServiceSquad continues to grow and evolve, it will keep striving to make service opportunities more accessible and impactful, one connection at a time.</p>
                    </Col>
                    <Col lg={4} className="right-div">
                        <Stack gap={3} className="right-div-stack-container">
